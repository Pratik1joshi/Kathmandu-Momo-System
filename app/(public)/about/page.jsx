...
export const metadata = {
  title: 'About',
  description: `About ${RESTAURANT.name} — momo, Nepali kitchen and café in Birendranagar, Surkhet.`,
    ...
    <div className="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-10 py-12">
      <div className="grid items-center gap-8 lg:grid-cols-2">
        ...
        <div className="overflow-hidden rounded-2xl border" style={{ borderColor: 'var(--dsp-border)' }}>
          ...
          <img src={about.image} alt="Kathmandu Momo" className="h-72 w-full object-cover sm:h-[26rem]" />
        </div>
      </div>
