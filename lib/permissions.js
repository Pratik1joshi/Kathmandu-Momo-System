...
export const PERMISSION_CATALOG = [
  ...
  { key: 'orders.delete', label: 'Delete an order', category: 'Orders', roles: ['cashier'], description: 'Permanently remove a cancelled order and its lines. Cancelling an order is a separate, less destructive permission.' },
...
const DEFAULTS = {
  ...
  // Both default OFF: these were admin-only before the matrix existed, and
  // they are destructive. An admin can switch them on per role.
  'orders.delete': { waiter: false, cashier: false, kitchen: false },
