...
const DEFAULTS = {
  ...
  'dashboard.view': { waiter: false, cashier: false, kitchen: false },
  'menu.manage': { waiter: false, cashier: false, kitchen: false },
  'delivery.manage': { waiter: false, cashier: false, kitchen: false },
  'inventory.dashboard.view': { waiter: false, cashier: false, kitchen: false },
  'inventory.manage': { waiter: false, cashier: false, kitchen: false },
  'inventory.setup.manage': { waiter: false, cashier: false, kitchen: false },
  'wastage.manage': { waiter: false, cashier: true, kitchen: false },
  'expenses.manage': { waiter: false, cashier: true, kitchen: false },
  'savings.manage': { waiter: false, cashier: false, kitchen: false },
  ...
  'corrections.manage': { waiter: false, cashier: false, kitchen: false },
  'general_ledger.view': { waiter: false, cashier: false, kitchen: false },
};
