  ...
  switch (action) {
    ...
    case 'complete': {
      ...
      return db.transaction(async (tx) => {
        ...
        // Carried forward, not rejected — see the note in
        // app/api/admin/pos/orders/[id]/pay/route.js. An online order accepted
        // before the day rolled over must still be completable.
