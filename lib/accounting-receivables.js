...
import { ensureSplitPaymentSchema, collectCreditBalance } from '@/lib/split-payments.js';
...
export async function outstandingCreditBills(db, customerId) {
  return db.all(
    `SELECT b.id, b.bill_number, b.grand_total, b.outstanding_amount, b.created_at, b.payment_status
     FROM bills b
...
export async function collectCustomerCredit(db, {
  customer_id, amount, method = 'cash', reference = null, bank_account_id = null,
