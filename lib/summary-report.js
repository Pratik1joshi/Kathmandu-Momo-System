...
export async function buildSummaryReport(db, { start, end }) {
  ...
  const [revenue, refundMedia, voidMedia, corrections, ledger, purchases, expenses, salaryRows, cashAccount, bankAccount, savings, saleCategories, purchaseCategories, quantities, settings, costMap, closing] = await Promise.all([
