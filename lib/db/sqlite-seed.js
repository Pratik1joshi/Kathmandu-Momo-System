...
export function seedDemoData(db) {
  ...
  const users = [
    { username: 'admin', pin: '123456', name: 'Kathmandu Momo Admin', role: 'admin' },
  ...
  const settings = [
    { key: 'restaurant_name', value: 'Kathmandu Momo (Demo)' },
    { key: 'restaurant_address', value: 'Birendranagar, Surkhet, Karnali, Nepal' },
    { key: 'restaurant_phone', value: '+977 984-9216081' },
    { key: 'restaurant_email', value: '' },
    { key: 'currency_symbol', value: 'Rs' },
    { key: 'vat_percentage', value: '13' },
    { key: 'service_charge_percentage', value: '10' },
    { key: 'receipt_footer', value: 'Thank you for visiting Kathmandu Momo!' },
    { key: 'owner_name', value: 'Demo Owner' },
  ];
